...
Follow the comments in the code for a walkthrough of the model's (and function's) development. If you use this code yourselves, make sure to have the csv in the same folder as the py file.
